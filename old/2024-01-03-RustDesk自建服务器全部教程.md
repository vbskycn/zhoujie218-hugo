...
![image-20240103191312350](/images/2024/01/b9d0c04afc72125756af8f4f3ff81082.webp)
...
\[![部署新的实例](/images/2024/01/1af60ccd91e21f1ed27705b522f84258.webp)\]

部署新的实例

出于个人习惯，我使用Debian系列的系统镜像；你可以和我一样，也可以按个人喜好选择Ubuntu、CentOS等，不过我不是很推荐CentOS、Redhat（毕竟CentOS现在已经停止维护）

[![本次部署新的实例](/images/2024/01/bc9dc51b6dd55b8e93944f0cf73f74ce.webp)](#newServerEC2Dtl.webp)

本次部署新的实例

在**密钥对（登录）**中，我们最好创建RSA密钥对，方便我们一会进行SSH的远程登录： \[![创建密钥对](/images/2024/01/8fdf4676415e4c92382916cc1553b9cf.webp)\]

创建密钥对

创建好后，密钥会自动下载： \[![创建并下载下来的密钥](/images/2024/01/1d30734bdc79efe9d370229699baf536.webp)\]
...
\[![放行全部端口](/images/2024/01/e74306708ecc68c030101b38de54d6e3.webp)\]

放行全部端口

## 连接服务器

之后，我们就可以连接服务器；举个例子，我这次最后购买的EC2: \[![本次使用的EC2实例](/images/2024/01/bc9dc51b6dd55b8e93944f0cf73f74ce.webp)\]

本次使用的EC2实例

点击进入，我们的可以使用公网IP进行登录（这里我分配了弹性IP）： \[![公网IPV4](/images/2024/01/db7627844d6023ff73b17b371449a90c.webp)\]
...
比如我远程登录成功： \[![使用RSA远程登录成功](/images/2024/01/846cd5e122a8ae92f7cac19d7f981d69.webp)\]
...
\[![设置时区](/images/2024/01/5c7c38480208a68061f57f101028df14.webp)\]
...
> 如果你想直接使用新用户进行SSH的登录，你可以修改SSH服务端配置(`/etc/ssh/sshd_config`)，其中的运行密码登录注释或者设置为**yes**的： \[![允许密码登录](/images/2024/01/6397afcf3ce3751063f1b3f1df68218a.webp)\]
...
这样，就可以使用用户进行密码登录： \[![密码登录成功](/images/2024/01/0cb617835d2476fadebd574820f551de.webp)\]
...
我们使用的是X86版本服务器，所以这里我们下载X86版本的服务包： \[![下载X86版本的服务端](/images/2024/01/d5485fd83a9332f0910778eb18e2a528.webp)\]
...
\[![下载解压并重命名](/images/2024/01/e6b4fc3dfd13b35c2911e814ccd8c860.webp)\]
...
\[![RustDesk Server内包含的内容](/images/2024/01/d7039a5479a1c796e296378b39847f55.webp)\]
...
通常情况下就会启动成功： \[![使用screen启动hbbs](/images/2024/01/0411e4584b8b54d5fb44fe0ec47affab.webp)\]
...
到此，如果没什么防火墙、安全组问题，RustDesk就启动完成了。 \[![使用screen启动hbbr](/images/2024/01/3089c64e4a077a2c374273c6e0d6fc02.webp)\]

使用screen启动hbbr

\[![使用screen启动完成](/images/2024/01/644e4f652e0d2e4f4ebfeee9d4c52268.webp)\]
...
我们需要拷贝`.pub`这个公钥文件，用于接下来的**本地配置**： \[![拷贝公钥文件](/images/2024/01/77322646e4af9e252a45ba806074ca2c.webp)\]
...
比如： 我这里安装macOS，并打开： [![在macOS上打开RustDesk](/images/2024/01/52e1f461d0d7281dcbb2bd3aa70cf7cf.webp)](#openRustDeskClient_macOS.webp)

在macOS上打开RustDesk

点击上面的三个点，进入配置： \[![进入RustDesk的配置界面](/images/2024/01/a0f18acc98623a923b80e3c234a0160e.webp)\]

进入RustDesk的配置界面

找到网络配置： \[![网络配置界面](/images/2024/01/016b9a2d87063cf64720ce8818acb2b2.webp)\]

网络配置界面

解锁网络配置，上方两个输入你的服务器IP，下方的Key输入上一步内我们拷贝的公钥（对于我是`C6bJn7*******************50nCK3y4=`），如果你有使用域名，IP部分也可以使用域名（CDN不行）： \[![配置我们自己的服务器](/images/2024/01/a17df8ffb3fd5c021800e176f62719bd.webp)\]
...
\[![Linux上安装RustDesk](/images/2024/01/abbd31822bfc6ebd38845dc1424c3b2f.webp)\]

Linux上安装RustDesk

安装好后，打开RustDesk： \[![Linux上打开RustDesk](/images/2024/01/a0bb14a32f92546d7119cd9460afe753.webp)\]

Linux上打开RustDesk

和刚刚一样，我们需要配置好我们自己的服务器参数。在macOS上就可以远程它了： \[![macOS上发起远程请求](/images/2024/01/30f77b117de883efa831d53c52a7257f.webp)\] macOS上发起远程请求

这个时候，实际上Linux上也是可以直接点击接受的： \[![Linux上接受远程请求](/images/2024/01/09599aa3b4e897b895b32fc98dc7aa78.webp)\]

Linux上接受远程请求

最后的“套娃”效果： \[![远程协助的效果](/images/2024/01/978f9af20393ae4fc4e48609e50f2ca8.webp)\] 远程协助的效果
...
\[![安装好nvm](/images/2024/01/f74340a4b8f44a3371a5af2c90985f8d.webp)\]

安装好nvm

\[![安装好pm2](/images/2024/01/30f77b117de883efa831d53c52a7257f.webp)\]
...
\[![启动完成后](/images/2024/01/e536b8e7a33a9d6c8be55598b09257bd.webp)\]
...
这样，客户端建立的连接，就需要强制设置好key，也就是我们的`*.pub`文件，否则无法建立通讯和远程连接： \[![强制密钥验证](/images/2024/01/01ed231784fdb85b7c8b349f679b4dee.webp)\]
...
![开源免费的全平台远程控制软件 RustDesk](/images/2024/01/f5b0620488982b9c2fa45368cc3cb0fe.webp)
...
![开源免费的全平台远程控制软件 RustDesk](/images/2024/01/276563269328b6c0f8db11fb9baf0803.webp)
